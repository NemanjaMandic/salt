...
function salt_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary-top', 'salt' ),
		'menu-2' => esc_html__( 'Primary-bottom', 'salt' ),
	) );
...
function salt_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'salt' ),
...
function salt_scripts() {
    ...
    wp_enqueue_style( 'salt-font', "https://fonts.googleapis.com/css?family=Josefin+Sans:400,600,700" );
...
function new_excerpt_more($more) {
       global $post;
	return '<br><br><a class="moretag" href="'. get_permalink($post->ID) . '"><span> Read more</span></a>';
}
...
class My_Walker extends Walker_Nav_Menu{
 ...
 var $number = 1;
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $item_output .= '</a>';
        $item_output .= '<span class="underline"></span>';
